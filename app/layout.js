...
export async function generateMetadata() {
  ...
  let siteData;
  try {
    siteData = (await cosmic.objects.findOne({
      type: "globals",
      slug: "header"
      ...
      <body>
        ...
        <header className="header" key="headerelement">
          <h1 className="site-title">
            ...
            <small className="site-title__tag">{ siteData.metadata.site_tag }</small>
          </h1>
        </header>
        {children}
        <div className="footer">
          <div style={{ marginTop: 20 }}>
            <a href="https://www.cosmicjs.com" target="_blank" style={{ textDecoration: 'none' }}>
              <span style={{ float:'left', marginRight: 15, position: 'relative' }}>
