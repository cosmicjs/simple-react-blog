  ...
  return <div className="card">
    ...
    <div className="card-padding">
      ...
      <div className="blog__author">
        ...
        <div className="blog__author-title">by <a href={`/author/${post.metadata.author.slug}`}>{post.metadata.author.title}</a> on {helpers.stringToFriendlyDate(post.metadata.published_date)}</div>
